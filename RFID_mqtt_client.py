...
user_id = os.environ.get('USERID', 0)
user_password = os.environ.get('DB_PASSWORD', 'admin')
object_facade = None
dbname = os.environ.get('PGDATABASE', 'esp8266')

mqtt_id = os.environ.get('MQTTHOST', 'mosquitto')
mqtt_user = os.environ.get('MQTTUSER', 'admina')
mqtt_pass = os.environ.get('MQTTPASS', 'admin')
